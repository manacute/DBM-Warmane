...
-- General
local timerPhaseChange	= mod:NewPhaseTimer(45)
...
mod:AddTimerLine(DBM_CORE_L.SCENARIO_STAGE:format(1)..": "..L.Suffering)
...
mod:AddTimerLine(DBM_CORE_L.SCENARIO_STAGE:format(2)..": "..L.Desire)
...
local timerNextDeaden	= mod:NewCDTimer(31, 41410, nil, nil, nil, 5)
...
mod:AddTimerLine(DBM_CORE_L.SCENARIO_STAGE:format(3)..": "..L.Anger)
